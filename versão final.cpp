	...
	
{
    ...
    cout << "VOTAÇÃO DE APROVADOS."<< endl;
    ...
    cout << "João obteve " << ((vote4 * 100)/total) << " % dos votos."<< endl;
    ...
    cout << "VOTAÇÃO DE REPROVADOS."<< endl;
    
    cout << "\n";
    cout << "\n";

    cout << "Jair obteve " << ((nvote1 * 100)/ntotal) << " % de reprovação."<< endl;
    cout << "Lula ganhou " << ((nvote2 * 100)/ntotal) << " % de reprovação."<< endl;
    cout << "Marina ganhou " << ((nvote3 * 100)/ntotal) << " % de reprovação."<< endl;
    cout << "João ganhou " << ((nvote4 * 100)/ntotal) << " % de reprovação."<< endl;
    cout << "Eneias ganhou " << ((nvote5 * 100)/ntotal) << " % de reprovação."<< endl;
    cout << nvote6 << " Pessoa(s) que não souberam opinar: "<<((nvote6 * 100)/ntotal)<<" % dos votos."<< endl;
